  ...
  return (
    <div className="ml-2">
      ...
      <div className="flex items-center justify-center">
        <div className="flex flex-col items-center justify-center w-3/4 px-12 py-8">
          ...
          <div className="flex ">
            <div className="w-2/3">
              <img src={entry.imageUrl} className="rounded-sm" />
            </div>
            <div className="flex flex-col w-1/3 p-2 ml-4 rounded-sm bg-slate-100">
              <ViewMenu />
